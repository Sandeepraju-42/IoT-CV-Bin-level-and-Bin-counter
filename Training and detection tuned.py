# -*- coding: utf-8 -*-
"""
Created on Thu Apr 13 19:19:07 2023
...
!pip install Cython>=0.29.12 --user
...
IMAGE_PATH = os.path.join(paths['IMAGE_PATH'], 'test', 'half.6e188dba-da0b-11ed-aa20-28f10e0aa7f1.jpg')
...
while cap.isOpened(): 
    ...
    print(detections['detection_classes'],detections['detection_scores'],ct.timestamp())
